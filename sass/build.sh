...
cp -f gtk-darkest-noBorder.css	../Flat-Remix-GTK-Darkest-NoBorder/gtk-3.0/gtk.css
...
cp -f gtk-darkest-solid-noBorder.css 	../Flat-Remix-GTK-Darkest-Solid-NoBorder/gtk-3.0/gtk.css
