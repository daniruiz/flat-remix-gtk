...
DARKEST_SRC_FILE="assets-darkest.svg"
DARKEST_ASSETS_DIR="assets-darkest"

INDEX="assets.txt"

mkdir assets assets-dark assets-darkest menubar-toolbar
...
do
	...
	if [ -f $DARKEST_ASSETS_DIR/$i.png ]; then
		echo $DARKEST_ASSETS_DIR/$i.png exists.
	else
		echo
		echo Rendering $DARKEST_ASSETS_DIR/$i.png
		$INKSCAPE --export-id=$i \
		          --export-id-only \
		          --export-png=$DARKEST_ASSETS_DIR/$i.png $DARKEST_SRC_FILE >/dev/null \
		&& $OPTIPNG -o7 --quiet $DARKEST_ASSETS_DIR/$i.png 
	fi
done
...
cp $DARKEST_ASSETS_DIR/entry-toolbar.png menubar-toolbar/entry-toolbar-darkest.png
cp $DARKEST_ASSETS_DIR/entry-active-toolbar.png menubar-toolbar/entry-active-toolbar-darkest.png
cp $DARKEST_ASSETS_DIR/entry-disabled-toolbar.png menubar-toolbar/entry-disabled-toolbar-darkest.png

cp $DARKEST_ASSETS_DIR/menubar.png menubar-toolbar/menubar-darkest.png
cp $DARKEST_ASSETS_DIR/menubar_button.png menubar-toolbar/menubar_button-darkest.png
